...
- Current IFC viewers may not fully display the relationships between `IfcCostItem`, `IfcCostValue`, and the related IFC objects. Direct inspection of the IFC STEP file may therefore be necessary to verify the complete cost structure.
